...
import { type TEditStore } from './schemas.tsx';
...
interface IProps extends Omit<ComponentProps<'form'>, 'onSubmit'> {
  id?: string;
  form: UseFormReturn<TEditStore>;
  onSubmit: (data: TEditStore) => void;
  loading?: boolean;
  disabled?: boolean;
}


export const EditStoreForm: FC<IProps> = ({ id = 'store-form', form, onSubmit, disabled, ...props }) => {
        ...
        <FieldGroup className="grid grid-cols-6 gap-4">
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid} className="col-span-full md:col-span-3">
          ...
          <Controller
            ...
            control={form.control}
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid} className="col-span-full lg:col-span-2">
